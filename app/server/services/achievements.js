...
export const ACHIEVEMENTS = [
  ...
  { id: "todas-las-lecciones", name: "Sin dejar una", description: "Completa las 80 lecciones", secret: false, metric: "lessonsDone", target: 80 },
  // Constancia
  ...
  { id: "todos-los-cursos", name: "El plan completo", description: "Completa las 8 materias", secret: false, metric: "coursesCompleted", target: 8 },
  // Repaso
