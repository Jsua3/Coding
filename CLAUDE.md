...
- Comandos (desde `app/`): `npm start` (:3000), `npm test` (**137/137** deben pasar), `npm run seed`. El dev server guarda el backend en memoria: si sus respuestas parecen viejas, mátalo y relánzalo.
